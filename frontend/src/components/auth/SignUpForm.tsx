...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Set pesan sukses
      setSuccessMessage(
        "Register success! Check your email to activate account ✉️",
      );
  ...
  return (
    <div className="flex flex-col flex-1 w-full lg:w-1/2">
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        ...
        {/* SUCCESS ALERT */}
        {successMessage && (
          <div className="flex items-center gap-3 p-4 mb-6 text-sm text-green-700 bg-green-50 border border-green-200 rounded-xl animate-fade-in">
            <div className="flex items-center justify-center w-6 h-6 bg-green-200 rounded-full shrink-0">
              <svg
